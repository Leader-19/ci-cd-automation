...
export default function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <Card sx={{ height: '100%', overflow: 'hidden', transition: 'transform 180ms ease, box-shadow 180ms ease', '&:hover': { transform: 'translateY(-4px)', boxShadow: '0 12px 30px rgba(16,24,40,0.08)' } }}>
      <Box sx={{ height: 154, bgcolor: 'primary.main', color: '#fff', p: 2.5, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
