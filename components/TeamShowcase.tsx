...
export default function TeamShowcase() {
  ...
  return (
    <Box aria-label="Rotating showcase of PNC Team members" sx={{ position: 'relative', height: { xs: 390, sm: 500 }, maxWidth: 540, mx: 'auto', width: '100%' }}>
      ...
      <Box sx={{ position: 'absolute', inset: '8% 11% 5% 13%', borderRadius: 5, bgcolor: 'primary.main', opacity: 0.045, transform: 'rotate(-4deg)' }} />
      ...
      {cardSlots.map((slot, slotIndex) => {
        ...
        return (
          <Box
            ...
            sx={{ position: 'absolute', ...position, aspectRatio: '4 / 5', borderRadius: 2, overflow: 'hidden', border: '4px solid', borderColor: 'background.paper', boxShadow: '0 6px 18px rgba(16,24,40,0.10)', bgcolor: 'background.paper', zIndex: slotIndex + 1 }}
          >
